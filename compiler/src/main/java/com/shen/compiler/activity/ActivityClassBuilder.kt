...
import com.shen.compiler.activity.method.*
...
/*
* created by shen at 2019/9/2 11:29
*/
class ActivityClassBuilder (private val activityClass: ActivityClass) {
    ...
    private fun writeKotlinToFile(filer: Filer, fileSpec: FileSpec) {
        try {
            val fileObject = filer.createResource(StandardLocation.SOURCE_OUTPUT, activityClass.packageName,
                fileSpec.name + ".kt")
