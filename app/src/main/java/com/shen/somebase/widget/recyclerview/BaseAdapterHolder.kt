 ...
 * at 16:57
 **/
class BaseAdapterHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

    init {
        itemView.tag = "${this::class.java.simpleName}${itemView::class.java.simpleName}"
    }
    ...
    fun setText(@IdRes id: Int, value: String) = runBlockReturnSelf {
    ...
    private fun runBlockReturnSelf(block:() -> Unit): BaseAdapterHolder {
        block.invoke()
        return this
    }
}