...
/**
* Created by hongyonglang on 16/6/1.
*/
public class BaseAdapterHelper extends RecyclerView.ViewHolder {
   ...
   public LinearLayout getLinerLayout(int layoutId){
       return retrieveView(layoutId);
   }
   public GridView getGridviewLayout(int viewID){
       return retrieveView(viewID);
   }
   public RelativeLayout getRelativeLayout(int relative){return retrieveView(relative);}
   public FrameLayout getFrameLayout(int framlayoutid){
       return retrieveView(framlayoutid);
   }
